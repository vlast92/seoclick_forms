...
$document->addStyleSheet('/modules/mod_seoclick_forms/assets/css/popup_form_styles.min.css?v='
    .filemtime($_SERVER['DOCUMENT_ROOT'] . '/modules/mod_seoclick_forms/assets/css/popup_form_styles.min.css'));
$document->addScript('/modules/mod_seoclick_forms/assets/js/popup.min.js?v='
...
<div id="<?=$form_id?>" class="seoclick-forms seoclick-forms-popup-wrap <?= $moduleclass_sfx; ?>">
    <div class="seoclickFormsShowpopUpForm"><?= $showButtonText ?></div>
                ...
                <div class="field-wrap">
                    ...
                    <label><span class="fieldName"><?= $formField['label']; ?></span>
						...
						<?php elseif ($formField['type'] == "select"): ?>
                            <select name="<?= $name; ?>">
                                <option selected disabled><?= jText::_("MOD_SEOCLICK_FORMS_SELECT_CHOOSE_OPTION") ?></option>
